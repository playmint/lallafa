...
exports.instructionsProfileToString = exports.sourcesProfileToString = exports.profile = void 0;
function profile(trace, compilerOutput, inputSources) {
...
function sourcesProfileToString(sourcesProfile) {
...
function instructionsProfileToString(instructionsProfile) {
    const biggestGasNumber = instructionsProfile.reduce((biggest, instruction) => {
    ...
    const asmPad = instructionsProfile.reduce((longestAsmStr, instruction) => {
